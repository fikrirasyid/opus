...
add_action( 'customize_register', 'opus_customizer_register' );

/**
 * Customizer CSS
 */
function opus_customize_css(){
	$site_color = get_theme_mod( 'site_color' );
	$site_color_darker = opus_adjust_brightness( get_theme_mod( 'site_color' ), -50 );
...
add_action( 'wp_head', 'opus_customize_css' );
 ...
 */
function opus_adjust_brightness($hex, $steps) {
